  ...
  const validationSchema = Yup.object({
    ...
    information: Yup.object({
      ...
      bed: Yup.number()
        ...
        .min(1, "Phải lớn hơn 0")
        .required("Nhập số lượng giường ngủ"),
      bathroom: Yup.number()
      ...
      kitchen: Yup.number()
        ...
        .min(1, "Phải lớn hơn 0")
        .required("Nhập số lượng phòng bếp"),
      customer: Yup.number()
        .typeError("Số khách hàng phải là số")
        .min(1, "Phải lớn hơn 0")
        .required("Nhập số lượng khách hàng"),
      price: Yup.string()
              ...
              <Row>
                <Col>
                  <div className="mb-3">
                    ...
                    <Field
                      type="text"
                      name="information.kitchen"
                      className="form-control"
                      placeholder="Nhập số lượng nhà bếp"
                    />
