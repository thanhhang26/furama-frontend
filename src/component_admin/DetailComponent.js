  ...
  return (
    <div className="mt-4">
      ...
      <div className="ms-4 mb-3">
        <Link
          to={"/edit/" + id}
          className="btn btn-custom-outline me-2 rounded-2 px-4 py-2 shadow-sm transition"
          style={{
            transition: "0.3s",
          }}
        >
        ...
        <Link to={"/facilities"} className="btn btn-outline-secondary me-2 rounded-2 px-4 py-2 shadow-sm transition">
          Trở về
        </Link>
      </div>
    </div>
